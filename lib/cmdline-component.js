...
export default class CmdlineComponent extends Component {
  ...
  componentDidMount() {
    ...
    atom.commands.add(this.editorEl, 'core:move-up', () => this.moveHistory(-1));
    atom.commands.add(this.editorEl, 'core:move-down', () => this.moveHistory(1));

    atom.commands.add(this.editorEl, 'vmp-ex-mode:complete-next', () => this.moveCompletion(1));
    atom.commands.add(this.editorEl, 'vmp-ex-mode:complete-prev', () => this.moveCompletion(-1));
